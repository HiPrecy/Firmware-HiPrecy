 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "1.1.9.001"
   ...
   */
  #define MACHINE_NAME "HiPrecy LEO"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/HiPrecy/Marlin-1.x-HiPrecy"
   ...
   */
  #define WEBSITE_URL "http://www.hiprecy.com"
